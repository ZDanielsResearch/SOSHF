...
originalFile = fopen([dataFolder 'Corel5k-sparse.arff']);
...
originalFile = fopen([dataFolder 'Corel5k.xml']);
newFile = fopen([dataFolder 'Corel5kNew.xml'],'w');
