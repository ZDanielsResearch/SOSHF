dataFolder = [dataPath 'rcvsubset1/'];
...
originalFile = fopen([dataFolder 'rcv1subset1.arff'],'r');
...
originalFile = fopen([dataFolder 'rcv1subset1.xml']);
newFile = fopen([dataFolder 'rcv1subset1New.xml'],'w');
...
originalFile = fopen([dataFolder 'rcv1subset1.arff']);
