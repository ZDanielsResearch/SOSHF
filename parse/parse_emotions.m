...
originalFile = fopen([dataFolder 'emotions.arff']);
...
originalFile = fopen([dataFolder 'emotions.xml']);
newFile = fopen([dataFolder 'emotionsNew.xml'],'w');
