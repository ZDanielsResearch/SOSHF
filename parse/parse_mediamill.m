...
originalFile = fopen([dataFolder 'mediamill.arff'],'r');
...
originalFile = fopen([dataFolder 'mediamill.xml']);
newFile = fopen([dataFolder 'mediamillNew.xml'],'w');
...
originalFile = fopen([dataFolder 'mediamill.arff']);
