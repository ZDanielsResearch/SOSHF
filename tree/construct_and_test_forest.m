function [precisionTemp,recallTemp,f1Temp,AUCTemp] = construct_and_test_forest(trainingFeatures,trainingLabels,testFeatures,testLabels,numTrees,minLeaf,gamma,alpha,numIterations,labelSampling,featureSampling,instanceSampling,usedWeightParam)
...
for j = 1:1:numTrees
    disp(['Tree ' num2str(j)]);
    tree = construct_tree(trainingFeatures,trainingLabels,minLeaf,gamma,alpha,numIterations,labelSampling,featureSampling,instanceSampling,usedWeightParam);
