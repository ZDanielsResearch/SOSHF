function tree = construct_tree(features,labels,minLeaf,rho,alpha,numIterations,labelSampling,featureSampling,instanceSampling,usedWeightParam)
...
while sum(currentNode > 0) ~= 0
    ...
    for i = 1:1:length(nodeIDs)
        ...
        weightsNode = loss_optimize(featuresNode2,labelsNode,rho,alpha,numIterations,minLeaf,imbalance);
