function [precisionTemp,recallTemp,f1Temp,AUCTemp] = construct_and_test_forest_o_lr(trainingFeatures,trainingLabels,testFeatures,testLabels,numTrees,minLeaf,gamma,alpha,numIterations,labelSampling,featureSampling,instanceSampling,usedWeightParam)
...
for j = 1:1:numTrees
    disp(['Tree ' num2str(j)]);
    tree = construct_tree_o_lr(trainingFeatures,trainingLabels,minLeaf,gamma,alpha,numIterations,labelSampling,featureSampling,instanceSampling,usedWeightParam);
    %keyboard;
