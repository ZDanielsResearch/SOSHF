function tree = construct_tree_sf(features,labels,minLeaf,labelSampling,featureSampling,instanceSampling,usedWeightParam)
...
while sum(currentNode > 0) ~= 0
    ...
    for i = 1:1:length(nodeIDs)
        ...
        [index, thresh] = loss_optimize_sf_c(featuresNode2,labelsNode,minLeaf,imbalance);
