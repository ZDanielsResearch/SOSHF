function tree = construct_tree_o_lr(features,labels,minLeaf,rho,alpha,numIterations,labelSampling,featureSampling,instanceSampling,usedWeightParam)
...
%         weightsNode(selectedFeatures) = weightsNode2;
        ...
        labelsNode = labels(indices,:);
        weightsNode = loss_optimize_o_lr(featuresNode2,labelsNode,rho,alpha,numIterations,minLeaf,imbalance);
