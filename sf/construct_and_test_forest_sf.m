function [precisionTemp,recallTemp,f1Temp,AUCTemp] = construct_and_test_forest_sf(trainingFeatures,trainingLabels,testFeatures,testLabels,numTrees,minLeaf,labelSampling,featureSampling,instanceSampling,usedWeightParam)
...
for j = 1:1:numTrees
    disp(['Tree ' num2str(j)]);
    tree = construct_tree_sf(trainingFeatures,trainingLabels,minLeaf,labelSampling,featureSampling,instanceSampling,usedWeightParam);
